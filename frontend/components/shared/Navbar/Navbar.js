...
const Navbar = ( { navItems, } ) => {
  return (
    <div className={ `navbar-wrapper ${ styles.Navbar }` }>

      <nav className="navbar navbar-expand-lg navbar-dark fj-mw9">
        <a className="navbar-brand mr-3 font-weight-bold" href="/">Viktor Strelianyi</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav">
            { navItems && navItems.map( item => {
              return (
                <li className="nav-item mr-3" key={ item.databaseId }>
